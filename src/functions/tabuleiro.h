...
void setPlayersMapa(){
   ...
   // Nessa função se encontram ponteiros apontando para um endereço de char do tabuleiro.
	...
	casas_player4[0].posicao = &TABULEIRO[48][110]; //start        
	casas_player4[1].posicao = &TABULEIRO[48][93];
	casas_player4[2].posicao = &TABULEIRO[48][80];
	casas_player4[3].posicao = &TABULEIRO[48][67];
	casas_player4[4].posicao = &TABULEIRO[48][54];   
	casas_player4[5].posicao = &TABULEIRO[48][41];
	casas_player4[6].posicao = &TABULEIRO[48][28];
	casas_player4[7].posicao = &TABULEIRO[48][15];//detencao
	casas_player4[8].posicao = &TABULEIRO[42][15];
	casas_player4[9].posicao = &TABULEIRO[36][15];
	casas_player4[10].posicao = &TABULEIRO[29][15];
	casas_player4[11].posicao = &TABULEIRO[23][15];
	casas_player4[12].posicao = &TABULEIRO[17][15];
	casas_player4[13].posicao = &TABULEIRO[11][15];
	casas_player4[14].posicao = &TABULEIRO[2][15]; //ferias
	casas_player4[15].posicao = &TABULEIRO[2][28];
	casas_player4[16].posicao = &TABULEIRO[2][41];  
	casas_player4[17].posicao = &TABULEIRO[2][54];
	casas_player4[18].posicao = &TABULEIRO[2][57];
	casas_player4[19].posicao = &TABULEIRO[2][80];
	casas_player4[20].posicao = &TABULEIRO[2][93];
	casas_player4[21].posicao = &TABULEIRO[2][110];// va para cadeia
	casas_player4[22].posicao = &TABULEIRO[11][110];
	casas_player4[23].posicao = &TABULEIRO[17][110];
	casas_player4[24].posicao = &TABULEIRO[23][110];
	casas_player4[25].posicao = &TABULEIRO[29][110];
	casas_player4[26].posicao = &TABULEIRO[36][110];
	casas_player4[27].posicao = &TABULEIRO[42][110];
}