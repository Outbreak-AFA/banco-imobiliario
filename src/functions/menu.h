...
// Menu do jogo 
	...
	printf("\n");//
        ...
        printf("\n");
    printf("COMO JOGAR?\n");  // Instrucoes
    printf("1-Todos os jogadores devem jogar os dados para saber a ordem de jogada, devera ser organozado em ordem decrescente.\n");
    ...
    printf("5-Ao cair em uma casa de sorte ou reves, o jogador tera que receber uma carta e executar a ordem que nela contem .\n");
    ...
    printf("10-O jogador devera colocar uma casa em cada terreno do grupo de mesm,a cor antes do colocar a segunda.\n");
